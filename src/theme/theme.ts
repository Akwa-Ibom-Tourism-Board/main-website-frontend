...
export const theme = {
  ...
  gradients: {
    ...
    // Dark green blending into near-black, used behind the homepage hero.
    heroScene: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.heroDeep} 55%, ${colors.black} 100%)`,
    // A calmer, more uniform dark-green sweep for content panels (e.g. the
    // Destinations section) that still want a dark backdrop without the
    // hero's near-black endpoint.
    panel: `linear-gradient(160deg, ${colors.primary} 0%, ${colors.heroDeep} 100%)`,
    // Near-black footer backdrop: a soft green glow centered at top, fading
    // out to the dark base color toward the corners and further down.
