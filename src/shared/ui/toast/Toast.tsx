...
import { StyledViewport, StyledToast, StyledAction, StyledClose, StyledTitle, StyledDescription, type ToastVariant } from "./Toast.styles";
...
export type ToastProps = ComponentPropsWithoutRef<typeof ToastPrimitives.Root> & { variant?: ToastVariant };
